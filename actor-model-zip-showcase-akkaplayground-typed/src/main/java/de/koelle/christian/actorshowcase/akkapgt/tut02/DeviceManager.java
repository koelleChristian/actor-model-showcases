...
public class DeviceManager extends AbstractBehavior<DeviceManager.Command> {
    ...
    public static final class RespondAllTemperatures {
        final long requestId;
        final Map<String, TemperatureReadingObjs.TemperatureReading> temperatures;

        public RespondAllTemperatures(long requestId, Map<String, TemperatureReadingObjs.TemperatureReading> temperatures) {
            this.requestId = requestId;
